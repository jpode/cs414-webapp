...
var SinglePairOfLocations = function (_React$Component) {
  ...
  function SinglePairOfLocations(props) {
    ...
    _this.updateMetric = _this.updateMetric.bind(_this);
    return _this;
  }
  ...
  _createClass(SinglePairOfLocations, [{
    ...
    value: function handleSubmit(event) {
      ...
      /* checking for valid strings upon submit */
      ...
      if (!testA) {
        ...
        var tempDist = get_distance(temp_A_NS, temp_A_EW, temp_B_NS, temp_B_EW, this.state.metric);
        this.setState({ dist: tempDist });
      }
    }
  }, {
    key: "updateMetric",
    value: function updateMetric(event) {
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement("input", { type: "text", className: "text-right form-control mr-sm-2", placeholder: "Location 1",
        ...
        React.createElement("input", { type: "text", className: "text-right form-control mr-sm-2", placeholder: "Location 2",
        ...
        React.createElement("input", { type: "text", className: "text-right form-control mr-sm-2", placeholder: "Distance",
          value: this.state.dist, disabled: true }),
        React.createElement(
          "button",
          { className: "btn btn-secondary active", "aria-pressed": "true", value: "M", type: "button", onClick: this.updateMetric },
          " Miles "
        ),
        React.createElement(
          "button",
          { className: "btn btn-secondary active", "aria-pressed": "true", value: "K", type: "button", onClick: this.updateMetric },
          " Kilometers "
        )
      );
    }
